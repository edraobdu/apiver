...
- **0.1 build slices.** The actual implementation tickets. Wait on [09 — Squash feasibility](issues/09-squash-feasibility.md), [10 — Name and positioning](issues/10-name-and-positioning.md), and [12 — Gating semantics in detail](issues/12-gating-semantics.md) — and the reference project specifically waits on [11 — Reference project: shape and structure](issues/11-reference-project-shape.md) as well.
